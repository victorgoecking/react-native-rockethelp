...
import { OrderFirestireDTO } from '../DTOs/OrderFirestireDTO'
...
function handleOrderClose(){
  ...
  firestrore()
  .collection<OrderFirestireDTO>('orders')
  .doc(orderId)
  .update({
    status: 'closed',
    solution,
    closed_at: firestrore.FieldValue.serverTimestamp()
  })
  .then(() => {
  ...
  return (
    <VStack flex={1} bg="gray.700">
      ...
      <HStack bg="gray.500" justifyContent="center" p={4}>
        ...
        >
          {order.status === 'closed' ? 'finzalizado' : 'em andamento'}
        </Text>
